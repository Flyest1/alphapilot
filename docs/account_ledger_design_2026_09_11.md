...
비파괴 저장소와 공통 CSV 연결은 구현됐으며 [저장소 실행 안내](account_ledger_storage_2026_09_11.md)를 따른다.
운영 DB 마이그레이션 026/027과 원장 오류 복구 배포는 2026-09-23 완료했다.
실계좌 수집·수익률 계산은 완료되지 않았다. [현재 운영 기록](ledger_recovery_2026_09_23.md).
