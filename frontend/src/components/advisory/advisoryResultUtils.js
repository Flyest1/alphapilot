...
const STATUS_LABELS = {
  ...
  deeper_research_candidate: "심층 조사 후보",
  speculative_watch: "고위험 관찰",
  rejected_or_data_limited: "제외·근거 부족",
  biotech: "바이오",
  emerging_growth: "신흥 성장주",
  clinical_milestone: "임상 이정표",
  regulatory_milestone: "규제 이정표",
  commercial_milestone: "상업화 이정표",
  stale_or_missing_price_history: "가격 이력 누락·오래됨",
  market_cap_unavailable: "시가총액 누락",
  market_cap_outside_scope: "시가총액 범위 밖",
  insufficient_liquidity_evidence: "유동성 근거 부족",
  cash_balance_unavailable: "현금 잔액 누락",
  free_cash_flow_unavailable: "잉여현금흐름 누락",
  official_filing_evidence_unavailable: "공식 공시 근거 누락",
  going_concern_signal: "계속기업 경고",
  cash_runway_below_four_quarters: "현금 생존기간 4분기 미만",
...
export const FIELD_LABELS = {
  ...
  asymmetric_opportunity_score: "비대칭 기회 점수",
  upside_evidence_score: "상승 근거 점수",
  downside_risk_score: "하방 위험 점수",
  opportunity_status: "기회 상태",
  classification: "분류",
  risk_rating: "위험 등급",
  evaluation_status: "평가 상태",
  current_weight_pct: "현재 비중",
  position_weight_pct: "포트폴리오 비중",
  average_price: "평균단가",
  current_price: "현재가",
  unrealized_return_pct: "평가 수익률",
  return_rate: "평가 수익률",
  confidence: "판단 신뢰도",
  one_line_conclusion: "한 줄 결론",
  decision_reason: "판단 근거",
  primary_reasons: "핵심 이유",
  suitability_score: "적합도",
  current_view: "현재 판단",
  when_it_fits: "검토 조건",
  conflict_status: "리포트 관계",
  conflict_reason: "차이 설명",
  trigger_type: "재검토 유형",
  condition: "조건",
  response: "확인할 사항",
  scorecard: "판단 점수표",
  hold_support_score: "보유 지지 점수",
  realization_pressure_score: "이익실현 압력 점수",
  add_support_score: "추가 노출 지지 점수",
  technical_score: "기술 점수",
  price_framework: "가격 재검토 기준",
  profit_protection_reference: "이익 보호 확인선",
  upside_review_reference: "상승 여력 재검토선",
  trend_invalidation_reference: "추세 무효화 확인선",
  review_horizon: "검토 기간",
  risks: "핵심 위험",
  catalysts: "보유·상승 촉매",
  profit_basis_note: "손익 계산 기준",
  note: "안내",
  ...
  market_cap_usd: "시가총액",
  median_dollar_volume_usd: "중앙 거래대금",
  annualized_volatility_pct: "연환산 변동성",
  max_drawdown_pct: "최대 낙폭",
  cash_runway_quarters: "현금 생존 분기",
  speculative_track: "탐색 유형",
  official_catalyst_categories: "공시 촉매 범주",
  dilution_signal: "희석 신호",
    ...
    sections: [
      {
        key: "top_candidates",
        title: "심층 조사 후보",
        sort: "asymmetric_opportunity_score",
        fields: [
          "ticker",
          "name",
          "speculative_track",
          ...
          "official_catalyst_categories",
          "dilution_signal",
          "action",
        ],
      },
      {
        key: "speculative_watch",
        title: "고위험 관찰",
        sort: "asymmetric_opportunity_score",
        fields: [
          "ticker",
      ...
      {
        key: "rejected_or_data_limited",
        title: "제외·근거 부족",
        fields: ["ticker", "rejection_reasons", "analysis_status"],
      },
    ],
  },
